...
# Case study 2
# Group 10 
# Hannah Riley, Emily Perkins, Ryan Pollard, Chukwudike Nwokike
######################################################################################################################################################################
...
ui <- fluidPage(theme = shinytheme("cerulean"),
  ...
  sidebarLayout(
    sidebarPanel(align="center",
      ...
      sliderInput(inputId ="year", label = "Choose what year to view:",
                  min = 1853, max = 2020, value = 1853, sep = ""),
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(align="center", "What's the weather like in the city?", h3("What's the weather like in the cities of the UK?", align = "center"), strong("Drag, zoom and explore the map.
